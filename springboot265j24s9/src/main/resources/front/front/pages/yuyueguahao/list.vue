			...
			<view :style='{"minHeight":"100vh","width":"100%","padding":"0 0 160rpx","position":"relative","background":"#FEF9F3","height":"auto"}'>
					...
					<view class="list" :style='{"width":"100%","padding":"40rpx 0 0 0","margin":"0","height":"auto"}'>
						<view @tap="onDetailTap(product)" class="listm flex flex-between" :style='{"margin":"0 0 20rpx","borderRadius":"20rpx","flexWrap":"wrap","background":"#FFFFFF","display":"flex","width":"100%","height":"auto"}' v-for="(product,index) in list" :key="index">
							...
							<view class="listmr" :style='{"width":"calc(100% - 200rpx)","padding":"0","margin":"0","flexWrap":"wrap","display":"flex","height":"auto"}'>
								<view class="col3 f30 elip mb15" :style='{"width":"100%","padding":"10rpx 20rpx","lineHeight":"48rpx","fontSize":"32rpx","color":"#4A4A4A"}'>就诊人:{{product.xingming}}</view>
								...
								<view :style='{"padding":"0 20rpx"}'>
									...
									<text :style='{"color":"#8FBBD7","lineHeight":"1.5","fontSize":"24rpx"}'>{{product.yonghuzhanghao}}</text>
								</view>
							</view>
							<!-- #ifdef MP-WEIXIN -->
							<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('yuyueguahao','修改')) || (!userid && isAuthFront('yuyueguahao','修改'))" @tap.stop.proevent="onUpdate" :data-row="product">
								...
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('yuyueguahao','删除')) || (!userid && isAuthFront('yuyueguahao','删除'))" @tap.stop.proevent="onDelete" :data-row="product">
							...
							<!-- #ifndef MP-WEIXIN -->
							<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('yuyueguahao','修改')) || (!userid && isAuthFront('yuyueguahao','修改'))" @tap.stop.proevent="onUpdateTap(product)">
									<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}' class="cuIcon-edit"></text>
									<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}'>修改</text>
								</view>
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('yuyueguahao','删除')) || (!userid && isAuthFront('yuyueguahao','删除'))" @tap.stop.proevent="onDeleteTap(product.id)">
									<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}' class="cuIcon-delete"></text>
									<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}'>删除</text>
								</view>
							</view>
				...
				<view class="screenBox" :class="screenBoxShow?'screenBoxActive':''">
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","flexWrap":"wrap","justifyContent":"flex-start","display":"flex"}'>
						<view :style='{"width":"18%","padding":"20rpx 0","fontSize":"28rpx","color":"#858585"}'>用户姓名</view>
						<input :style='{"border":"2rpx solid #CCCCCC","width":"100%","padding":"0 20rpx 0 20rpx","borderRadius":"0","background":"#fff","height":"80rpx"}' placeholder="请输入用户姓名" v-model="searchForm.yonghuxingming">
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","flexWrap":"wrap","justifyContent":"flex-start","display":"flex"}'>
						<view :style='{"width":"18%","padding":"20rpx 0","fontSize":"28rpx","color":"#858585"}'>医生姓名</view>
						<input :style='{"border":"2rpx solid #CCCCCC","width":"100%","padding":"0 20rpx 0 20rpx","borderRadius":"0","background":"#fff","height":"80rpx"}' placeholder="请输入医生姓名" v-model="searchForm.yishengxingming">
					</view>
