				...
				<view class="screenBox" :class="screenBoxShow?'screenBoxActive':''">
					...
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0"}'>
						...
						<view :style='{"width":"100%","alignItems":"center","flexWrap":"wrap","justifyContent":"center","display":"flex"}'>
							<input :style='{"border":"2rpx solid #CCCCCC","borderRadius":"0","color":"#858585","textAlign":"center","background":"#fff","width":"46%","lineHeight":"80rpx","height":"80rpx"}' v-model="searchForm.remindtimestart" placeholder="提醒时间开始时间" @tap="toggleTab('remindtimestart')"></input>
							<view :style='{"color":"#CCCCCC","padding":"0 10rpx","fontSize":"20rpx"}'>-</view>
							<input :style='{"border":"2rpx solid #CCCCCC","borderRadius":"0","color":"#858585","textAlign":"center","background":"#fff","width":"46%","lineHeight":"80rpx","height":"80rpx"}' v-model="searchForm.remindtimeend" placeholder="提醒时间结束时间" @tap="toggleTab('remindtimeend')"></input>
						</view>
					</view>
