			...
			<view :style='{"minHeight":"100vh","width":"100%","padding":"0 0 160rpx","position":"relative","background":"#FEF9F3","height":"auto"}'>
				...
				<view :style='{"width":"100%","padding":"0 20rpx","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
					<view class="uni-product-list" :style='{"padding":"0","margin":"40rpx 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
						<view @tap="onDetailTap(product)" class="uni-product" :style='{"padding":"0 0 20rpx","margin":"0 0 20rpx","backgroundColor":"#fff","flexWrap":"wrap","display":"flex","width":"48%","height":"auto"}' v-for="(product,index) in list" :key="index">
							<view class="uni-product-title " :style='{"padding":"10rpx 20rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"1.4","fontSize":"28rpx","textOverflow":"ellipsis"}'>{{product.name}}</view>
