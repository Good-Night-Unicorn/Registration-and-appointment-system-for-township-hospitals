			...
			<view :style='{"minHeight":"100vh","width":"100%","padding":"0 0 160rpx","position":"relative","background":"#FEF9F3","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"width":"calc(100% - 0px)","padding":"20rpx ","position":"relative","background":"none","display":"flex","height":"auto"}'>
					<view :style='{"margin":"0","flex":"1","position":"relative"}' class="search-form round">
						...
						<input placeholder-style="color: #333" :style='{"border":"0px solid #27357C","padding":"12rpx 20rpx 12rpx 80rpx","boxShadow":"inset 0px 2rpx 8rpx 0px #00000040","color":"#333","borderRadius":"0","background":"#FFFFFF","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.title" type="text" placeholder="标题" ></input>
					</view>
				...
				<view :style='{"padding":"8rpx","margin":"0 20rpx","flexWrap":"wrap","background":"#FEF9F3","borderWidth":"0","display":"flex","width":"calc(100% - 40rpx)"}'>
					<view @click="sortClick('clicknum')" :style='{"border":"2rpx solid #C3C2C2","padding":"12rpx","margin":"0 8rpx 0 0","outline":"0","borderRadius":"0","background":"#F1F1F1","display":"flex"}'>
						<text :style='{"color":"#999","lineHeight":"48rpx","fontSize":"24rpx"}'>点击量</text>
						<text v-if="listSort!='clicknum'" class="icon iconfont icon-xiaoliang13" :style='{"margin":"0 4rpx 0 0","lineHeight":"48rpx","fontSize":"24rpx","color":"#999"}'></text>
						<text v-else-if="listSort=='clicknum'&&listOrder=='asc'" class="icon iconfont icon-xiaoliang13" :style='{"margin":"0 4rpx 0 0","lineHeight":"48rpx","fontSize":"24rpx","color":"#999"}'></text>
						<text v-else-if="listSort=='clicknum'&&listOrder=='desc'" class="icon iconfont icon-xiaoliang13" :style='{"margin":"0 4rpx 0 0","lineHeight":"48rpx","fontSize":"24rpx","color":"#999"}'></text>
					</view>
				...
				<view :style='{"width":"100%","padding":"0 20rpx","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
					...
					<!-- 样式4 -->
					<view v-if="list.length" class="news-box4" :style='{"padding":"24rpx","margin":"0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
						<block v-for="(product,index) in list" :key="index">
							<view @tap="onDetailTap(product)" v-if="index%2==0" class="list-item" :style='{"margin":"0 0 20rpx","borderRadius":"60rpx 0px 60rpx 0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"48%","height":"auto"}'>
								<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"60rpx 0px 60rpx 0px","display":"block","width":"100%","height":"300rpx","order":"-1"}' mode="aspectFill" class="listmpic" :src="baseUrl+product.picture"></image>
								<view class="list-item-body" :style='{"width":"100%","padding":"0","margin":"0","flexWrap":"wrap","display":"flex","height":"auto"}'>
									<view :style='{"width":"100%","padding":"0px 20rpx","lineHeight":"1.4","fontSize":"32rpx","color":"#4A4A4A","order":"1"}' class="title ">{{product.title}}</view>
									<view :style='{"width":"100%","padding":"0 20rpx","lineHeight":"1.5","fontSize":"24rpx","color":"#666","display":"none"}' class="text ">{{product.introduction}}</view>
									<view :style='{"padding":"0 20rpx","order":"9"}'>
										...
										<text :style='{"color":"#526FB2","lineHeight":"1.5","fontSize":"24rpx"}'>{{product.addtime.replace(/\-/g,'-').replace(/\:/g,':')}}</text>
									</view>
									<view :style='{"padding":"0 20rpx","order":"8"}'>
										...
										<text :style='{"color":"#8FBBD7","lineHeight":"1.5","fontSize":"24rpx"}'>{{product.name}}</text>
									</view>
									<view :style='{"padding":"0 20rpx","order":"6"}'>
										...
										<text :style='{"color":"#E5CF7B","lineHeight":"1.5","fontSize":"24rpx"}'>{{product.thumbsupnum}}</text>
									</view>
									...
									<view :style='{"padding":"0 20rpx","order":"7"}'>
										...
										<text :style='{"color":"#CBC2A7","lineHeight":"1.5","fontSize":"24rpx"}'>{{product.clicknum}}</text>
									</view>
								</view>
							</view>
							<view @tap="onDetailTap(product)" v-if="index%2==1" class="list-item" :style='{"margin":"0 0 20rpx","borderRadius":"60rpx 0px 60rpx 0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"48%","height":"auto"}'>
								<view class="list-item-body" :style='{"width":"100%","padding":"0","margin":"0","flexWrap":"wrap","display":"flex","height":"auto"}'>
									<view :style='{"width":"100%","padding":"0px 20rpx","lineHeight":"1.4","fontSize":"32rpx","color":"#4A4A4A","order":"1"}' class="title ">{{product.title}}</view>
									<view :style='{"width":"100%","padding":"0 20rpx","lineHeight":"1.5","fontSize":"24rpx","color":"#666","display":"none"}' class="text ">{{product.introduction}}</view>
									<view :style='{"padding":"0 20rpx","order":"9"}'>
