	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="挂号数" prop="shengyushuliang" >
					<el-select :disabled="ro.shengyushuliang" v-model.number="ruleForm.shengyushuliang" placeholder="请选择挂号数" >
						<el-option
							v-for="(item,index) in shengyushuliangOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="挂号数" prop="shengyushuliang" >
					<el-input v-model="ruleForm.shengyushuliang"
	...
	export default {
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='shengyushuliang'){
							this.ruleForm.shengyushuliang = obj[o];
							this.ro.shengyushuliang = true;
							continue;
						}
						if(o=='yuyueshijian'){
					...
					this.ruleForm.shengyushuliang = 0
					this.ro.shengyushuliang = false;
					this.ruleForm.shengyushuliang = Number('1'); 				}
				// 获取用户信息
				this.$http({
				...
				this.shengyushuliangOptions = "1".split(',')
			...
			async onSubmit() {
					...
					if(objcross!=null) {
						if(!this.ruleForm.shengyushuliang){
							this.$message.error("挂号数不能为空");
							return
						}
						objcross.shengyushuliang = objcross.shengyushuliang - this.ruleForm.shengyushuliang
						if(objcross.shengyushuliang<0){
